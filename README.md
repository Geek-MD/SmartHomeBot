...
- [X] Fixed a bug related with admin restricted commands, wich could be used by non admin users. [`v1.2.0`](https://github.com/Geek-MD/SmartHomeBot/releases/tag/v1.2.0)
